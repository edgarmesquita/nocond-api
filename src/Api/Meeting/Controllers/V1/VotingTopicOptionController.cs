...
{
    /// <summary>
    /// VotingTopicOption controller.
    /// </summary>
    [ApiController]
    [ApiVersion("1.0")]
    [Route("v{version:apiVersion}/voting-topic-options")]
    [OpenApiTag("Voting", Description = "Create, read, update and delete voting sessions, topic and options")]
    public class VotingTopicOptionController : CrudControllerBase<VotingTopicOptionRequest, VotingTopicOption, Guid>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VotingTopicOptionController"/> class.
        /// </summary>
        /// <param name="service">The service.</param>
        public VotingTopicOptionController(IVotingTopicOptionService service) : base(service) { }
        ...
        [ProducesResponseType(typeof(NoCond.Application.Meeting.Models.VotingTopicOption), StatusCodes.Status200OK)]
        ...
        [HttpGet("")]
        [ProducesResponseType(typeof(PagedListResult<NoCond.Application.Meeting.Models.VotingTopicOption>), StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public override Task<IActionResult> Post([FromBody] VotingTopicOptionRequest dto)
        {
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public override Task<IActionResult> Put([FromRoute] Guid id, [FromBody] VotingTopicOptionRequest dto)
        {
