...
{
    /// <summary>
    /// MeetingUnit controller.
    /// </summary>
    [ApiController]
    [ApiVersion("1.0")]
    [Route("v{version:apiVersion}/meeting-units")]
    [OpenApiTag("Meeting", Description = "Create, read, update and delete meetings and types")]
    public class MeetingUnitController : CrudControllerBase<MeetingUnitRequest, MeetingUnit, Guid>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MeetingUnitController"/> class.
        /// </summary>
        /// <param name="service">The service.</param>
        public MeetingUnitController(IMeetingUnitService service) : base(service) { }
        ...
        [ProducesResponseType(typeof(NoCond.Application.Meeting.Models.MeetingUnit), StatusCodes.Status200OK)]
        ...
        [HttpGet("")]
        [ProducesResponseType(typeof(PagedListResult<NoCond.Application.Meeting.Models.MeetingUnit>), StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public override Task<IActionResult> Post([FromBody] MeetingUnitRequest dto)
        {
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public override Task<IActionResult> Put([FromRoute] Guid id, [FromBody] MeetingUnitRequest dto)
        {
