...
{
    /// <summary>
    /// VotingTopic controller.
    /// </summary>
    [ApiController]
    [ApiVersion("1.0")]
    [Route("v{version:apiVersion}/voting-topics")]
    [OpenApiTag("Voting", Description = "Create, read, update and delete voting sessions, topic and options")]
    public class VotingTopicController : CrudControllerBase<VotingTopicRequest, VotingTopic, Guid>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VotingTopicController"/> class.
        /// </summary>
        /// <param name="service">The service.</param>
        public VotingTopicController(IVotingTopicService service) : base(service) { }
        ...
        [ProducesResponseType(typeof(NoCond.Application.Meeting.Models.VotingTopic), StatusCodes.Status200OK)]
        ...
        [HttpGet("")]
        [ProducesResponseType(typeof(PagedListResult<NoCond.Application.Meeting.Models.VotingTopic>), StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public override Task<IActionResult> Post([FromBody] VotingTopicRequest dto)
        {
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public override Task<IActionResult> Put([FromRoute] Guid id, [FromBody] VotingTopicRequest dto)
        {
