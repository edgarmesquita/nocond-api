...
namespace NoCond.Api.Unit.Controllers.V1
{
    ...
    [ApiController]
    [ApiVersion("1.0")]
    [Route("v{version:apiVersion}/owner-types")]
    [OpenApiTag("Owner", Description = "Create, read, update and delete owners and types")]
    public class OwnerTypeController : CrudControllerBase<OwnerTypeRequest, OwnerType, Guid>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OwnerTypeController"/> class.
        /// </summary>
        /// <param name="service">The service.</param>
        public OwnerTypeController(IOwnerTypeService service) : base(service) { }
        ...
        [ProducesResponseType(typeof(OwnerType), StatusCodes.Status200OK)]
        ...
        [HttpGet("")]
        [ProducesResponseType(typeof(PagedListResult<OwnerType>), StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public override Task<IActionResult> Post([FromBody] OwnerTypeRequest dto)
        {
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public override Task<IActionResult> Put([FromRoute] Guid id, [FromBody] OwnerTypeRequest dto)
        {
