...
namespace NoCond.Api.Unit.Controllers.V1
{
    ...
    [ApiController]
    [ApiVersion("1.0")]
    [Route("v{version:apiVersion}/unit-types")]
    [OpenApiTag("Unit", Description = "Create, read, update and delete unit, groups and types")]
    public class UnitTypeController : CrudControllerBase<UnitTypeRequest, UnitType, Guid>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UnitTypeController"/> class.
        /// </summary>
        /// <param name="service">The service.</param>
        public UnitTypeController(IUnitTypeService service) : base(service) { }
        ...
        [ProducesResponseType(typeof(UnitType), StatusCodes.Status200OK)]
        ...
        [HttpGet("")]
        [ProducesResponseType(typeof(PagedListResult<UnitType>), StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public override Task<IActionResult> Post([FromBody] UnitTypeRequest dto)
        {
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public override Task<IActionResult> Put([FromRoute] Guid id, [FromBody] UnitTypeRequest dto)
        {
