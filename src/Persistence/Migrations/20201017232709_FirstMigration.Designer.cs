...
namespace NoCond.Persistence.Migrations
{
    ...
    [Migration("20201017232709_FirstMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NoCond.Application.Meeting.Data.OwnerData", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("NoCond.Application.Meeting.Data.OwnerTypeData", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("OwnerTypeId")
            ...
            modelBuilder.Entity("NoCond.Application.Meeting.Data.UnitData", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("UnitId")
            ...
            modelBuilder.Entity("NoCond.Application.Meeting.Data.UnitTypeData", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("UnitTypeId")
            ...
            modelBuilder.Entity("NoCond.Application.Meeting.Data.MeetingUnitData", b =>
                {
                    ...
                    b.HasOne("NoCond.Application.Meeting.Data.UnitData", "Unit")
                        .WithMany("WithMeetings")
            ...
            modelBuilder.Entity("NoCond.Application.Meeting.Data.OwnerData", b =>
                {
                    b.HasOne("NoCond.Application.Meeting.Data.OwnerTypeData", "Type")
                        .WithMany("Owners")
            ...
            modelBuilder.Entity("NoCond.Application.Meeting.Data.PersonData", b =>
                {
                    ...
                    b.HasOne("NoCond.Application.Meeting.Data.OwnerData", "Owner")
                        .WithOne("Person")
            ...
            modelBuilder.Entity("NoCond.Application.Meeting.Data.UnitData", b =>
                {
                    b.HasOne("NoCond.Application.Meeting.Data.UnitTypeData", "Type")
                        .WithMany("Units")
