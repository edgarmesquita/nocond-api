...
namespace NoCond.Persistence.Migrations
{
    ...
    [Migration("20201124002126_PersonTypeMigration")]
    partial class PersonTypeMigration
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NoCond.Application.Meeting.Data.VotingTopicCandidateData", b =>
                {
                    ...
                    b.HasKey("VotingTopicId", "PersonId");

                    b.HasIndex("PersonId");

                    b.ToTable("VotingTopicCandidates");
                });
            ...
            modelBuilder.Entity("NoCond.Application.Person.Data.AddressData", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("NoCond.Application.Person.Data.PersonAdressesData", b =>
                {
                    b.Property<Guid>("PersonId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NoCond.Application.Person.Data.PersonData", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("NoCond.Application.Unit.Data.UnitData", b =>
                {
                    ...
                    b.Property<Guid?>("UnitGroupDataId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NoCond.Application.Unit.Data.UnitGroupData", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("NoCond.Application.Meeting.Data.VotingTopicCandidateData", b =>
                {
                    b.HasOne("NoCond.Application.Person.Data.PersonData", "Person")
                        .WithMany("WithCandidates")
            ...
            modelBuilder.Entity("NoCond.Application.Person.Data.PersonAdressesData", b =>
                {
                    b.HasOne("NoCond.Application.Person.Data.AddressData", "Address")
            ...
            modelBuilder.Entity("NoCond.Application.Unit.Data.UnitData", b =>
                {
                    b.HasOne("NoCond.Application.Unit.Data.UnitGroupData", null)
                        .WithMany("Units")
                        .HasForeignKey("UnitGroupDataId");
